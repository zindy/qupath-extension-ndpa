...
This repo contains a ndpa and instructions to help create a new extension for [QuPath](https://qupath.github.io).
...
[dependencies]
io.github.qupath:qupath-extension-ndpa
```
...
QuPath itself is developed using IntelliJ, and you can import the extension ndpa there.
...
You can develop the extension using either Java or Groovy - the ndpa includes examples of both.
...
There are two examples in the ndpa, in two languages:
* **Java:** `qupath.ext.ndpa.NdpaExtension.java`.
* **Groovy:** `qupath.ext.ndpa.NdpaGroovyExtension.java`.
...
![Screenshot from 2024-03-14 18-44-42](https://github.com/alanocallaghan/qupath-extension-ndpa/assets/10779688/4712a209-eda7-4f80-8bed-bbab20e4f50a)
...
https://github.com/qupath/qupath-extension-ndpa/blob/778f02759d8a7fe5c73f1751edd58b6494beff9f/src/main/java/qupath/ext/ndpa/NdpaExtension.java#L65-L66
...
This is just a ndpa, you're free to use it however you like.
